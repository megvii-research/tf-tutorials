...
class Dataset():
    ...
    def instance_generator(self):
        for i in range(self.instances):
            ...
            gt_img = cv2.imread(self.images[idx].split('/input_rggb/')[0] + '/groundtruth/' + self.images[idx].split('/input_rggb/')[-1])
